...
SAMPLES = [
    ("samples/layout_alignment/container_alignment.py", "layout_alignment_container.png"),
    ("samples/layout_alignment/row_alignment.py", "layout_alignment_row.png"),
    ("samples/layout_alignment/row_cross_alignment.py", "layout_alignment_row_cross.png"),
    ("samples/layout_alignment/column_alignment.py", "layout_alignment_column.png"),
    ("samples/layout_alignment/column_cross_alignment.py", "layout_alignment_column_cross.png"),
    ("samples/layout_alignment/cross_aligned_widget.py", "layout_alignment_cross_aligned.png"),
    ("samples/layout_basics/basic_column.py", "layout_basics_column.png"),
    ("samples/layout_basics/basic_row.py", "layout_basics_row.png"),
    ("samples/layout_basics/row_column_combination.py", "layout_basics_form.png"),
    ("samples/layout_sizing/fixed_size.py", "layout_sizing_fixed.png"),
    ("samples/layout_sizing/auto_size.py", "layout_sizing_auto.png"),
    ("samples/layout_sizing/flex_width.py", "layout_sizing_fullwidth.png"),
    ("samples/layout_spacing/padding_demo.py", "layout_spacing_padding.png"),
    ("samples/layout_spacing/gap_demo.py", "layout_spacing_gap.png"),
    ("samples/layout_spacing/spacer_demo.py", "layout_spacing_spacer.png"),
    ("samples/layout_spacing/container_margin.py", "layout_spacing_container.png"),
    ("samples/layout_overflow/default_overflow.py", "layout_overflow_default.png"),
    ("samples/layout_overflow/clipped_content.py", "layout_overflow_clipped.png"),
    ("samples/layout_overflow/scrollable_list.py", "layout_overflow_scrollable.png"),
    ("samples/layout_grid/step1_grid.py", "layout_grid_step1.png"),
    ("samples/layout_grid/step2_span.py", "layout_grid_step2.png"),
    ("samples/layout_grid/step3_sizing.py", "layout_grid_step3.png"),
    # Step 4 は完成形(app_layout_grid.py)の画像を使うので、専用の生成はしない（または final と同じでよい）
    # app_layout_grid.py は layout_grid_final.png として生成
    ("samples/layout_grid/app_layout_grid.py", "layout_grid_final.png"),
    ("samples/layout_grid/named_areas_grid.py", "layout_grid_named.png"),
    ("samples/layout_extras/stack_demo.py", "layout_extras_stack.png"),
    ("samples/layout_extras/flow_minimal_demo.py", "layout_extras_flow.png"),
    ("samples/layout_extras/uniform_flow_minimal_demo.py", "layout_extras_uniform_flow.png"),
    ...
    ("samples/dialogs/view_model_direct.py", "dialogs_view_model_direct.png"),
    ("samples/dialogs/view_model_intent.py", "dialogs_view_model_intent.png"),
    ("samples/dialogs/custom_intent.py", "dialogs_custom_intent.png"),
    # Modifiers
    ("samples/modifier/basic_usage.py", "modifier_basic.png"),
    ("samples/modifier_decoration/background_border.py", "modifier_decoration_bg_border.png"),
    ("samples/modifier_decoration/corner_radius_clip.py", "modifier_decoration_radius_clip.png"),
    ("samples/modifier_decoration/shadow.py", "modifier_decoration_shadow.png"),
    ("samples/modifier_interaction/clickable.py", "modifier_interaction_clickable.png"),
    ("samples/modifier_interaction/hoverable.py", "modifier_interaction_hoverable.png"),
    ("samples/modifier_interaction/focusable.py", "modifier_interaction_focusable.png"),
    ...
    ("samples/modifier_others/visible_animated.py", "modifier_others_visible_animated.png"),
    # Popup modifiers
    ("samples/modifier_popup/modeless_basic.py", "modifier_popup_modeless.png"),
    ("samples/modifier_popup/light_dismiss_menu.py", "modifier_popup_light_dismiss.png"),
    ("samples/modifier_popup/tooltip_basic.py", "modifier_popup_tooltip.png"),
    # Navigation
    ...
    ("samples/navigation/sub.py", "navigation_sub.png"),
    # README samples
    ...
    # Window Chrome
    ("samples/window_chrome/os_chrome_default.py", "window_chrome_os_default.png"),
    ("samples/window_chrome/custom_chrome.py", "window_chrome_custom.png"),
    ("samples/window_chrome/no_chrome.py", "window_chrome_borderless.png"),
    # Material App
    ("samples/material_app/basic_usage.py", "material_app_basic_usage.png"),
    # Material Overlay
    ("samples/material_overlay/snackbar.py", "material_overlay_snackbar.png"),
    ("samples/material_overlay/bottom_sheet.py", "material_overlay_bottom_sheet.png"),
    ("samples/material_overlay/side_sheet.py", "material_overlay_side_sheet.png"),
    ("samples/material_overlay/loading.py", "material_overlay_loading.png"),
    # Material Theme
    ("samples/material_theme/no_theme.py", "material_theme_no_theme.png"),
    ("samples/material_theme/seed_color.py", "material_theme_seed_color.png"),
    ("samples/material_theme/dark_mode.py", "material_theme_dark_mode.png"),
    # Material Widgets
    ("samples/material_widgets/text.py", "material_widgets_text.png"),
    ("samples/material_widgets/icon.py", "material_widgets_icon.png"),
    ("samples/material_widgets/button.py", "material_widgets_button.png"),
    ...
    ("samples/material_widgets/card.py", "material_widgets_card.png"),
    ("samples/material_widgets/chip.py", "material_widgets_chip.png"),
    ("samples/material_widgets/badge.py", "material_widgets_badge.png"),
    ("samples/material_widgets/divider.py", "material_widgets_divider.png"),
    ("samples/material_widgets/progress.py", "material_widgets_progress.png"),
    ("samples/material_widgets/navigation_rail.py", "material_widgets_navigation_rail.png"),
    ...
    ("samples/theme_extensions/custom_color_token.py", "theme_extensions_light_dark.png"),
]
